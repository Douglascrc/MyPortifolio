import "./Hero.css";
import Profile from "../../assets/terninho.jpg";
const Hero = () => {
  return (
    <section
      id="home"
      className="hero-container flex relative items-center ml-8 my-6"
    >
      ...
      <div className="hero-img flex flex-1 flex-col items-center gap-8 mt-20">
        <div className="flex gap-2 items-end">
          <div className="tech-icon w-24 h-24 items-center justify-center flex text-center border border-solid border-[#6852ba] rounded-xl">
            <img
              className="w-16 transition-all ease-in duration-300 hover:-translate-y-2"
          ...
          <img
            className="w-6/12 h-1/6 p-6 rounded-full  object-top ease-in duration-300 hover:-translate-y-2"
            src={Profile}
            alt=""
          />
        </div>
